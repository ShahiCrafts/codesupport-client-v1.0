...
const values = [
  {
    ...
    title: 'Quality First',
    description: 'We never compromise on the quality of our work. Every project undergoes thorough review.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Everything we do is designed with students\' success in mind.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const team = [
  {
    ...
    bio: 'Former senior engineer at top tech companies with 10+ years of experience.',
  },
  {
    name: 'Sarah Chen',
    role: 'Head of Quality Assurance',
    bio: 'Quality expert ensuring every deliverable meets our high standards.',
  },
  {
  ...
  },
  {
    ...
    bio: 'Technical writer with expertise in creating clear, comprehensive documentation.',
  },
];
