  ...
  const benefits = [
    {
      ...
      description: 'Projects completed in hours, not days. Meet every deadline with confidence.'
    },
    {
      icon: FaShieldAlt,
      title: 'Quality Assured',
      description: 'Every deliverable undergoes rigorous review. Unlimited revisions included.'
    },
    {
      icon: FaLightbulb,
      title: 'Learn While You Submit',
      description: 'Comprehensive documentation explains the implementation approach.'
    },
    {
      icon: FaHeadset,
      title: 'Round-the-Clock Support',
      description: 'Technical support available 24/7. We are here whenever you need us.'
    }
  ];
  ...
  const steps = [
    {
      ...
      description: 'Upload project details, specifications, and deadline requirements.',
      icon: FaTerminal
    },
    {
      number: '02',
      title: 'Expert Assignment',
      description: 'A specialist matching your tech stack is assigned to your project.',
  ...
  const faqs = [
    {
      ...
      answer: 'Standard projects are completed within 24-48 hours. Urgent requests can be expedited to 6-12 hours depending on complexity. Timeline is confirmed before project initiation.'
    },
    {
      question: 'How is confidentiality maintained?',
      answer: 'All projects are handled with strict confidentiality. Developers sign NDAs, and we use encrypted communication channels. Your information is never shared with third parties.'
    },
    {
      question: 'What is your revision policy?',
      answer: 'Unlimited revisions are included until you are completely satisfied with the deliverable. Our goal is your success.'
    },
    {
      question: 'Which technologies do you support?',
      answer: 'We support all major programming languages and frameworks including Python, Java, JavaScript, C/C++, React, Node.js, Django, Spring Boot, TensorFlow, and more.'
    },
    {
      question: 'How does the payment process work?',
      answer: 'A 50% deposit initiates the project, with the balance due upon completion. We offer multiple secure payment methods and provide a money-back guarantee.'
    }
  ];
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 rounded-lg transition-colors"
              >
                Get Help Now
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-zinc-400">
              A streamlined process designed to get your project completed efficiently and professionally.
            </p>
          </div>
      ...
      <section id="testimonials" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-zinc-400">
              Hear from students who have achieved their academic goals with our assistance.
            </p>
          </div>
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  ...
                  <FaChevronDown
                    className={`text-zinc-500 text-xs flex-shrink-0 transition-transform duration-200 ${openFaq === idx ? 'rotate-180' : ''}`}
                  />
                </button>
                <div className={`overflow-hidden transition-all duration-200 ${openFaq === idx ? 'max-h-40' : 'max-h-0'}`}>
                  <p className="px-5 pb-5 text-sm text-zinc-500 leading-relaxed">{faq.answer}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-zinc-400 mb-10 max-w-xl mx-auto">
            Join thousands of students who have achieved academic success with professional code assistance.
          </p>
          ...
          <p className="mt-8 text-xs text-zinc-600">
            No credit card required • Free consultation • 100% satisfaction guaranteed
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-sm text-zinc-500 hover:text-zinc-300 transition-colors">Pricing</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-sm text-zinc-500 hover:text-zinc-300 transition-colors">Cookies</a></li>
              </ul>
            </div>
          </div>
